...
// Map DB row -> app Venta (only real columns from public.ventas)
function mapVenta(row: any): Venta {
  return {
    ...
    monto_asistencia_agente: 0,
    monto_asistencia_empresa: 0,
    tipo_pago_comision: (row.tipo_pago_comision === 'parcial' ? 'parcial' : 'unico') as any,
    monto_total_comision_a_pagar: 0,
    monto_pagado_comision: 0,
    porcentaje_pagado_comision: 0,
